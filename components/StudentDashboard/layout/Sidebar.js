...
import {
  faThLarge,faSignOutAlt, faSchool ,faFileLines,faClipboardList
    ...
    >
      ...
      <div className="p-4 border-b">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <p className="font-medium">Suryansu Sanjeebani Mohanty</p>
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        <a href="#" className="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-slate-100 text-slate-600">
          <FontAwesomeIcon icon={faClipboardList} className="w-5 text-center" />
          <span>My Forms</span>
        </a>
      </nav>
